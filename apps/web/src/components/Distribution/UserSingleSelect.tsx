        ...
        return (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className={`h-6 w-6 rounded-full border inline-flex items-center justify-center flex-shrink-0 ${selected ? "border-primary bg-primary/15" : "border-primary/70"}`}>
                {selected ? <span className="h-2.5 w-2.5 rounded-full bg-primary" /> : <Circle size={16} className="text-primary/80" />}
              </span>
            </div>
          </button>
        );
