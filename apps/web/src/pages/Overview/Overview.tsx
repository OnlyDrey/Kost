...
function PeriodSelector({
  ...
  const inputCls =
    "px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent";
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {period && (
            <TagPill
              label={!closed ? t("period.open") : t("period.closed")}
              variant={!closed ? "success" : "danger"}
              shape="rounded"
              size="md"
            />
          )}
                  ...
                  <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 shadow-sm">
                    <div className="mb-3 flex items-center justify-between gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 text-xs font-semibold rounded-md border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Reset
                      </button>
                    </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between gap-2 flex-wrap">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-2 rounded-lg text-sm font-semibold transition-colors"
              >
                <Plus size={15} />
              ...
              visibleGroups.map((group) => {
                ...
                return (
                  ...
                  >
                    <div className="mb-3">
                      <h3
                        className={`text-base font-semibold ${group.titleClass}`}
                      >
                        {group.title}
                      </h3>
                      <p
