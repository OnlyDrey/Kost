...
describe("AllocationService", () => {
    ...
    it("should always sum to total (property-based)", () => {
      fc.assert(
        fc.property(
          ...
          fc.array(fc.integer({ min: 1, max: 9999 }), {
            minLength: 2,
            maxLength: 5,
          }), // percents
          (totalCents, percents) => {
      ...
      const participants = [
        {
          userId: "user1",
          userName: "Kari",
          normalizedMonthlyGrossCents: 5000000,
        },
  ...
  describe("splitFixed", () => {
    it("should split with fixed amounts and equal remainder", () => {
      ...
      const result = service.splitFixed(
        totalCents,
        fixedRules,
        "EQUAL",
        allParticipants,
      ...
      const participants = [
        {
          userId: "user1",
          userName: "User1",
          normalizedMonthlyGrossCents: 1000000,
        },
        {
          userId: "user2",
          userName: "User2",
