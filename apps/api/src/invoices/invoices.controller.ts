...
export class InvoicesController {
  ...
  @ApiResponse({
    status: 200,
    description: "List of invoices with shares and payments",
  })
  findByPeriod(
    ...
    return this.invoicesService.findByPeriod(periodId, familyId, currentUserId);
  }
  ...
  @ApiResponse({
    status: 200,
    description: "Invoice details with shares and payments",
  })
  ...
  findOne(
    ...
    return this.invoicesService.findOne(id, familyId, currentUserId);
  }

  @Post()
  @ApiOperation({
    summary: "Create a new invoice with automatic share calculation",
  })
  @ApiResponse({ status: 201, description: "Invoice created successfully" })
  @ApiResponse({
    status: 400,
    description: "Validation error or period is closed",
  })
  ...
  @Patch(":id")
  @ApiOperation({
    summary: "Update an invoice (recalculates shares if distribution changes)",
  })
  ...
  remove(
    ...
    return this.invoicesService.remove(id, familyId, currentUserId);
  }
