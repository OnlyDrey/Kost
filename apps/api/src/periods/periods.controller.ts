...
export class PeriodsController {
  ...
  findOne(
    ...
    return this.periodsService.findOne(id, familyId, user.sub);
  }
  ...
  getPeriodStats(
    ...
    return this.periodsService.getPeriodStats(id, familyId, user.sub);
  }
  ...
  getPeriodStatus(
    ...
    return this.periodsService.getPeriodStatus(id, familyId, user.sub);
  }
