import { IsString, IsNotEmpty, IsInt, Min, IsEnum, IsDateString, IsOptional, IsBoolean, ValidateNested } from 'class-validator';
...
export class CreateSubscriptionDto {
  ...
  @ApiProperty({ example: 'monthly', description: 'Frequency: monthly, yearly, etc.' })
  @IsString()
  @IsNotEmpty()
  frequency: string;

  @ApiPropertyOptional({ example: 15, description: 'Day of month when subscription renews (1-31)' })
  @IsInt()
  @Min(1)
  @IsOptional()
  dayOfMonth?: number;
  ...
  @ApiProperty({ description: 'Distribution rules (percentRules, fixedRules, remainderMethod)' })
  @ValidateNested()
  @Type(() => Object)
