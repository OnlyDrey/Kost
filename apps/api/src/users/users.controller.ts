...
export class UsersController {
  ...
  create(@Body() createUserDto: CreateUserDto, @CurrentUser('familyId') familyId: string) {
  ...
  update(
    ...
    return this.usersService.update(id, updateUserDto, user.familyId, user.sub, user.role as UserRole);
  }
