...
export class IncomesController {
  ...
  @ApiResponse({ status: 201, description: 'Income created/updated successfully' })
  @ApiResponse({ status: 400, description: 'Period is closed' })
  @ApiResponse({ status: 404, description: 'User or period not found' })
  create(@Body() createIncomeDto: CreateIncomeDto, @CurrentUser('familyId') familyId: string) {
