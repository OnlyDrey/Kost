...
async function main() {
  ...
  const aksel = await prisma.user.create({
    data: {
      username: 'aksel',
      name: 'Aksel',
      passwordHash,
  ...
  console.log(`Created users: ${admin.name}, ${andreas.name}, ${marta.name}, ${aksel.name} (password: kostpass)`);
  ...
  const vendorNames = [
    ...
    // Common recurring subscription vendors
    { name: 'Netflix', logoUrl: 'https://logo.clearbit.com/netflix.com' },
    { name: 'Spotify', logoUrl: 'https://logo.clearbit.com/spotify.com' },
    { name: 'Disney+', logoUrl: 'https://logo.clearbit.com/disneyplus.com' },
    { name: 'Max', logoUrl: 'https://logo.clearbit.com/max.com' },
    ...
    { name: 'Amazon Prime', logoUrl: 'https://logo.clearbit.com/primevideo.com' },
    { name: 'YouTube', logoUrl: 'https://logo.clearbit.com/youtube.com' },
  ];
  ...
  console.log('\nSeed completed!');
  console.log(`  Users: admin / andreas / marta / aksel (password: kostpass)`);
  console.log(`  Period: 2026-02 (open)`);
  console.log(`  Invoices: 10 (Bolig, Forsikring, Bil)`);
  console.log(`  Subscriptions: 5`);
  console.log(`  Seed mode: reset-style idempotent (safe to re-run in dev)`);
}
