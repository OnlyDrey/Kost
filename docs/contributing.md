...
## Web UI/state guardrails
Se `docs/ui-state-guardrails.md` for terminologi, delte komponentmønstre, klikkmodell for tiles/andeler og state-regler for faste utgifter.
